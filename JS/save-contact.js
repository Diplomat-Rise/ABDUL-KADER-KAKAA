...
BEGIN:VCARD
VERSION:3.0
FN:ABDUL KADER KAKAA
TITLE:Sales Manager
ORG:RISE Properties
TEL;TYPE=WORK,VOICE:+971526244172
TEL;TYPE=WORK,VOICE:+971557840301
TEL;TYPE=WORK,VOICE:+97145665109
EMAIL:Abdulkader.Kaka@riseproperties.ae
URL:http://www.riseproperties.ae
...
END:VCARD
  ...
  const a = document.createElement('a');
  a.href = url;
  a.download = 'ABDUL KADER KAKAA.vcf';
  document.body.appendChild(a);
  a.click();
  document.body.removeChild(a);
  URL.revokeObjectURL(url);
